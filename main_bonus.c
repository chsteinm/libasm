...
int main(int ac, char **av) {
    ...
    test_case("--42", "0123456789", 42, "Double moins");
    test_case("+-42", "0123456789", -42, "Plus et moins");
    ...
    test_case("poneyvif", "poneyvif", 342391, "Base custom");
    test_case("love", "love", 27, "Base avec doublons");
    
    // Tests limites
    test_case("1111111111111111111111111111111", "01", 2147483647, "Overflow binaire");
